...
*Remove missing values, bin by steps/day, calculate mean and median steps/day and display all in a single histogram*
```{r}
...
*Fill in missing values using Amelia (http://cran.r-project.org/web/packages/Amelia/Amelia.pdf) (pretty badly) and create new dataset*
```{r}
library(Amelia)
